<?php
	...
	$query = mysqli_query($koneksi, "SELECT pesanan.nama_penerima, pesanan.nomor_telepon, pesanan.alamat, pesanan.tanggal_pemesanan, user.nama, kecamatan.kecamatan, kecamatan.tarif FROM pesanan JOIN user ON pesanan.user_id=user.user_id JOIN kecamatan ON kecamatan.kecamatan_id=pesanan.kecamatan_id WHERE pesanan.pesanan_id='$pesanan_id'");
...
<div id="frame-keterangan-pembayaran">
    <p>Silahkan Lakukan pembayaran ke BANK BCA SYARIAH<br />
        ...
        <a
            href="<?php echo BASE_URL."my_profile.php?page=my_profile&module=pesanan&action=konfirmasi_pembayaran&pesanan_id=$pesanan_id"?>">Disini</a>.
    </p>
